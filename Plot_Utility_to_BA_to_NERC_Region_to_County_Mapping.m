...
data_input_dir = '/Users/burl878/OneDrive - PNNL/Documents/IMMM/Random/County_Mapping_Workflow/';
image_output_dir = '/Users/burl878/OneDrive - PNNL/Documents/IMMM/Random/County_Mapping_Workflow/Figures/';

% Choose whether or not to save the figures generated (1 = yes):
save_images = 1;

% Set the geographic boundaries for the CONUS plots:
lat_min = 24.4;
lat_max = 50.0;
lon_min = -125.9;
lon_max = -65.6;
...
load([data_input_dir,'Utility_to_BA_to_NERC_Region_to_County_Mapping.mat']);
...
if save_images == 1
   ...
   print(a,'-dpng','-r295',[image_output_dir,'Number_of_Utilities.png']);
   close(a);
end
...
if save_images == 1
   set(gcf,'Renderer','zbuffer'); set(gcf,'PaperPositionMode','auto');
   print(a,'-dpng','-r295',[image_output_dir,'Number_of_NERC_Regions.png']);
   close(a);
end
clear a ax1 colo1 i states faceColors
...
if save_images == 1
   set(gcf,'Renderer','zbuffer'); set(gcf,'PaperPositionMode','auto');
   print(a,'-dpng','-r295',[image_output_dir,'Number_of_BAs.png']);
   close(a);
end
clear a ax1 colo1 i states faceColors
...
if save_images == 1
   set(gcf,'Renderer','zbuffer'); set(gcf,'PaperPositionMode','auto');
   print(a,'-dpng','-r295',[image_output_dir,'Primary_BA.png']);
   close(a);
end
clear a ax1 colo1 i states faceColors
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear data_input_dir data_output_dir lat_max lat_min lon_max lon_min save_images image_output_dir Unique_BA_Label_Strings Unique_NERC_Region_Label_Strings
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                 END CLEANUP SECTION                 %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%