...
[~,~,Raw_Data1] = xlsread([data_input_dir,'Sales_Ult_Cust_2017.xlsx'],'States','B4:I3261');
Raw_Data1(cellfun(@(x) ~isempty(x) && isnumeric(x) && isnan(x),Raw_Data1)) = {''};
[~,~,Raw_Data2] = xlsread([data_input_dir,'Sales_Ult_Cust_2017.xlsx'],'States','W4:W3261');
...
% Save the output
save([data_output_dir,'Sales_Ult_Cust_2017.mat'],'Utility','Utility_Table'); 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
