...
data_input_dir = '/Users/burl878/OneDrive - PNNL/Documents/IMMM/Random/County_Mapping_Workflow/Raw_Data/';
data_output_dir = '/Users/burl878/OneDrive - PNNL/Documents/IMMM/Random/County_Mapping_Workflow/';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% mapping:
load([data_input_dir,'Utility_Data_2017.mat']);
...
% mapping:
load([data_input_dir,'Service_Territory_2017.mat']);
...
% Save the output:
save([data_output_dir,'Utility_to_BA_to_NERC_Region_to_County_Mapping.mat'],'County_Metadata','County_Metadata_Table');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear data_input_dir data_output_dir
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                 END CLEANUP SECTION                 %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%