...
[~,~,Raw_Data] = xlsread([data_input_dir,'Utility_Data_2017.xlsx'],'States','B3:N2290');
...
% Save the output:
save([data_output_dir,'Utility_Data_2017.mat'],'Utility','Utility_Table'); 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
