...
data_input_dir = '/Users/burl878/OneDrive - PNNL/Documents/IMMM/Random/County_Mapping_Workflow/Raw_Data/f8612017/';
data_output_dir = '/Users/burl878/OneDrive - PNNL/Documents/IMMM/Random/County_Mapping_Workflow/Raw_Data/';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
load([data_output_dir,'County_Metadata.mat']);

% Read the raw data from the spreadsheet into a cell structure:
[~,~,Raw_Data] = xlsread([data_input_dir,'Service_Territory_2017.xlsx'],'Counties_States','B2:E11828');
...
save([data_output_dir,'Service_Territory_2017.mat'],'Service_Territory','Service_Territory_Table'); 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear data_input_dir data_output_dir County_Metadata County_Metadata_Table
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                 END CLEANUP SECTION                 %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%